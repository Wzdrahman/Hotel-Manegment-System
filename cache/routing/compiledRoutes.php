...
$app->map("/log", "\\App\\Controllers\\LoginController::___index")->via("GET")->name("intern.index");
$app->map("/log", "\\App\\Controllers\\LoginController::___loginPost")->via("POST")->name("intern.data");
